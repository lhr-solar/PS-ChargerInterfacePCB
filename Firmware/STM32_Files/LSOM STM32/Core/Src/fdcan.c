...
void HAL_FDCAN_MspInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  */
    ...
    PA12     ------> FDCAN1_TX
    */
    GPIO_InitStruct.Pin = ElconCAN_RX_Pin|ElconCAN_TX_Pin;
...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  /* USER CODE END FDCAN1_MspDeInit 0 */
    ...
    PA12     ------> FDCAN1_TX
    */
    HAL_GPIO_DeInit(GPIOA, ElconCAN_RX_Pin|ElconCAN_TX_Pin);
  ...
  /* USER CODE END FDCAN3_MspDeInit 0 */
    ...
    PB4     ------> FDCAN3_TX
    */
    HAL_GPIO_DeInit(GPIOB, CarCAN_RX_Pin|CarCAN_TX_Pin);
