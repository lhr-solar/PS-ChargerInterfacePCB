...
#define CAN_DLC_SUPP_BATTERY_STATUS 5
#define CAN_DLC_SUPP_BATTERY_CHARGER_STATUS 5
...
typedef enum {
    CHARGERINTERFACE_STATUS_ELCON_COMM_OK_OK = 1,
    CHARGERINTERFACE_STATUS_ELCON_COMM_OK_NOT_OK = 0,
} chargerinterface_status_elcon_comm_ok_e;

typedef enum {
    CHARGERINTERFACE_STATUS_ELCON_FAULT_FAULT = 1,
    CHARGERINTERFACE_STATUS_ELCON_FAULT_OK = 0,
} chargerinterface_status_elcon_fault_e;
